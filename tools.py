...
def compress_photo():
    '''调用压缩图片的函数
    '''
    src_dir, des_dir = "album/", "album_mini/"
...
def handle_photo():
    ...
    -----------
    最后将data.json文件存到博客的source/blog-album文件夹下
    '''
    src_dir, des_dir = "album/", "album_mini/"
    ...
    with open("D:/program/GitHub/Hexo/source/blog-album/data.json","w") as fp:
...
if __name__ == "__main__":
    ...
    compress_photo()   # 压缩图片，并保存到album_mini文件夹下
